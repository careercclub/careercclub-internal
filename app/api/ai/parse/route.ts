...
const schemas = {
  ticket: "{title, description, status: Todo|In Progress|Done, priority: High|Med|Low, due_date: YYYY-MM-DD|null}",
  ...
  task: "{title, description, status: Todo|On Progress|Done, priority: High|Med|Low, phase: Pre Event|Hari H|Post Event, due_date: YYYY-MM-DD|null}",
  dashboard: "{module: ticket|task|carousel|voucher|partnership, data: object containing the fields for that module}",
} as const;
