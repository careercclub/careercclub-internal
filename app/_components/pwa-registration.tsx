...
export function PwaRegistration() {
  ...
  useEffect(() => {
    ...
    void navigator.serviceWorker.register("/sw.js", { scope: "/" }).then((registration) => { updateTimer = setInterval(() => void registration.update(), 60 * 60 * 1000); }).catch((error) => console.error("Service worker registration failed", error));
