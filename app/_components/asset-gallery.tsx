      ...
      {transfer ? (
        <Card className="gap-3 p-4">
          ...
          <form action={sendToLibrary} className="grid gap-2.5 sm:grid-cols-2">
            <label className="col-span-full grid gap-1 text-[10px] font-semibold text-muted-foreground uppercase"><span>Library type</span><select className="h-9 rounded-md border border-input px-2 text-xs font-normal normal-case text-foreground" name="tipe"><option value="organic">Organic Ideas</option><option value="ads">Ad Ideas</option></select></label>
            ...
            <label className="grid gap-1 text-[10px] font-semibold text-muted-foreground uppercase"><span>Source URL</span><input className="h-9 rounded-md border border-input px-2 text-xs font-normal normal-case text-foreground" defaultValue={String(transfer.link || "")} name="link" required /></label>
