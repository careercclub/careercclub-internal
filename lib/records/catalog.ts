...
export const recordDefinitions = {
  ...
  content_evaluations: {
    ...
    fields: [{ name: "post_id", label: "Post ID" }, { name: "account_id", label: "Account ID" }, { name: "account_username", label: "Account username" }, { name: "judul", label: "Title", required: true }, { name: "description", label: "Description", type: "textarea" }, { name: "url", label: "Post URL" }, { name: "format", label: "Format", type: "select", options: ["Carousel", "Reels", "Story", "Single Image"] }, { name: "tanggal", label: "Publish date", type: "date" }, { name: "topik", label: "Topic" }, { name: "followers", label: "Followers", type: "number" }, { name: "views", label: "Views", type: "number" }, { name: "reach", label: "Reach", type: "number" }, { name: "likes", label: "Likes", type: "number" }, { name: "comments", label: "Comments", type: "number" }, { name: "saves", label: "Saves", type: "number" }, { name: "shares", label: "Shares", type: "number" }, { name: "win", label: "What worked", type: "textarea" }, { name: "improve", label: "Improve", type: "textarea" }, { name: "action", label: "Next action", type: "textarea" }, { name: "thumbnail_url", label: "Thumbnail key / URL", storageArea: "uploads" }],
  },
  ads_contents: {
  ...
  tasks: {
    ...
    fields: [{ name: "project_id", label: "Program ID" }, { name: "title", label: "Title", required: true }, { name: "description", label: "Description", type: "textarea" }, { name: "status", label: "Status", type: "select", options: ["Todo", "In Progress", "Done"] }, { name: "priority", label: "Priority", type: "select", options: ["Low", "Med", "High", "Urgent"] }, { name: "phase", label: "Phase", type: "select", options: ["Pre Event", "Event Day", "Post Event"] }, { name: "assignee_id", label: "Primary assignee ID" }, { name: "assignee_ids", label: "Assignee UUIDs", type: "uuid-array", placeholder: "uuid, uuid" }, { name: "due_date", label: "Deadline", type: "date" }, { name: "ticket_id", label: "Linked ticket ID" }, { name: "gcal_added", label: "Added to calendar", type: "checkbox" }, { name: "attachments", label: "Attachments JSON", type: "json", placeholder: "[]" }],
  },
  ...
  free_class_eval: {
    table: "free_class_eval", title: "Free class evaluation", eyebrow: "Customer knowledge", path: "/customer-knowledge/free-class", orderBy: "created_at", ascending: false,
    description: "Analyze attendee ratings and qualitative feedback imported from free-class surveys.", columns: ["seri", "nama", "email", "kepuasan", "minat", "rekomendasi"],
    fields: [{ name: "email", label: "Email", required: true }, { name: "seri", label: "Class series", required: true }, { name: "nama", label: "Name" }, { name: "universitas", label: "University" }, { name: "angkatan", label: "Cohort" }, { name: "timestamp", label: "Timestamp" }, { name: "materi_judul", label: "Material matches title", type: "number" }, { name: "materi_kebutuhan", label: "Material meets needs", type: "number" }, { name: "materi_mudah", label: "Material clarity", type: "number" }, { name: "materi_jawab", label: "Questions answered", type: "number" }, { name: "nara_kuasai", label: "Speaker mastery", type: "number" }, { name: "nara_jelas", label: "Speaker clarity", type: "number" }, { name: "kualitas_teknis", label: "Technical quality", type: "number" }, { name: "waktu", label: "Timing", type: "number" }, { name: "moderator", label: "Moderator", type: "number" }, { name: "info_webinar", label: "Information access", type: "number" }, { name: "kepuasan", label: "Satisfaction", type: "number" }, { name: "minat", label: "Future interest", type: "number" }, { name: "rekomendasi", label: "Recommendation", type: "number" }, { name: "hal_baik", label: "What worked", type: "textarea" }, { name: "ditingkatkan", label: "What to improve", type: "textarea" }, { name: "topik_keinginan", label: "Requested topics", type: "textarea" }],
  },
  tkt_divisi: {
  ...
  product_pain_points: {
    ...
    description: "Customer problems addressed by each product.", columns: ["product_id", "text", "severity", "source"],
    fields: [{ name: "product_id", label: "Product ID", required: true }, { name: "text", label: "Pain point", type: "textarea", required: true }, { name: "severity", label: "Severity", type: "select", options: ["Low", "Med", "High"] }, { name: "source", label: "Source" }],
  },
  product_passion_points: {
    ...
    description: "Customer aspirations and motivations connected to each product.", columns: ["product_id", "text", "severity", "source"],
    fields: [{ name: "product_id", label: "Product ID", required: true }, { name: "text", label: "Passion point", type: "textarea", required: true }, { name: "severity", label: "Severity", type: "select", options: ["Low", "Med", "High"] }, { name: "source", label: "Source" }],
  },
  sub_products: {
